        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-0">
                <div class="marketing">
                    ...
                    <h3>SALES <span>REPRESENTATIVES</span> FROM ALL OVER <br> THE WORLD ARE <span>AVAILABLE</span> TO HELP YOU</h3>
                </div>
...
<section class="marketing1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="main5">
                <h2><span>EFFORTLESSLY</span> MANAGE YOUR SALES <span>PARTNERSHIPS</span> </h2>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                ...
                <h2>IS IT TIME TO <span>PARTNER </span> WITH YOUR FIRST <span>INDEPENDENT SALESPERSON?</span></h2>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                <a href="">GET STARTED</a>
                </div>
