    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-0">
                <div class="marketing">
                    <h2>VENTURE CAPITALIST</h2>
                    <h3>BUILDING A STRONGER, MORE DIVERSE, EQUITABLE, AND INCLUSIVE FUTURE FOR VENTURE CAPITAL. </h3>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <img src="images/img13.png" alt="" class="img-fluid">
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="main5">
                <h2> <span> VENTURE</span>  CAPITAL FOR THE FOUNDERS <span>BUILDING</span> A <span> BETTER</span> TOMORROW </h2>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                ...
                <h2><span>FOUNDER</span> -FOCUSED VENTURE <span> CAPITAL</span> </h2>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                <a href="">GET STARTED</a>
                </div>
